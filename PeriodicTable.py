...
class PeriodicTable:
    ...
    def get_dct_of_block(self, block_list: list[int]) -> dict:
        result = {}
        knowledge_list = list(self.elements_dict.items())
        for idx in block_list:
            symbol, answer_bool = knowledge_list[idx - 1]
            result[symbol] = answer_bool
    ...
    def get_s_block_dct(self):
        return self.s_block_dct

    def get_p_block_dct(self):
        return self.p_block_dct

    def get_d_block_dct(self):
        return self.d_block_dct

    def get_f_block_dct(self):
        return self.f_block_dct
